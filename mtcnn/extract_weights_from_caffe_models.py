...
You don't have to use this script because weights are already in `mtcnn/src/weights`.
"""
...
np.save('mtcnn/src/weights/pnet.npy', get_all_weights(net))

# R-Net
net = caffe.Net('caffe_models/det2.prototxt', 'caffe_models/det2.caffemodel', caffe.TEST)
np.save('mtcnn/src/weights/rnet.npy', get_all_weights(net))

# O-Net
net = caffe.Net('caffe_models/det3.prototxt', 'caffe_models/det3.caffemodel', caffe.TEST)
np.save('mtcnn/src/weights/onet.npy', get_all_weights(net))
